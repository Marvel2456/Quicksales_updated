...
class ProductForm(ModelForm):
    class Meta:
       model = Product
       fields = ('product_name', 'category', 'brand', 'quantity', 'cost_price', 'sale_price', 'unit', 'batch_no')
...
class EditProductForm(ModelForm):
    class Meta:
        model = Product
        fields = ('product_name', 'brand', 'quantity', 'cost_price', 'sale_price', 'unit', 'batch_no', 'reorder_level',)
